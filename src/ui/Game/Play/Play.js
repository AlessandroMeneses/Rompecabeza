...
import papel from "../../../assets/sounds/papel.mp3";
...
export class Play extends React.Component {
    ...
    handleSwapPieces = pivot => (piece) => {
        ...
        if (this.audioRef) {
            this.audioRef.currentTime = 0; // Reinicia el audio desde el inicio
            this.audioRef.play();          // Reproduce el sonido
        }
    ...
    render() {
        ...
        return (
            <div className="Play">
                ...
                <audio ref={this.setAudioRef} preload="auto">
                    <source src={papel} type="audio/mpeg" />
                </audio>
                <button className="button" onClick={onQuit}>Salir</button>
            </div>
        )
    }
}
